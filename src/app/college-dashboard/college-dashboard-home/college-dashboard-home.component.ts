...
@Component({
  selector: 'app-college-dashboard-home',
  templateUrl: './college-dashboard-home.component.html',
  styleUrls: ['./college-dashboard-home.component.css']
})
export class CollegeDashboardHomeComponent implements OnInit {
